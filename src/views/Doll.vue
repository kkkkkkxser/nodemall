<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>毛绒玩具</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- banner栏 -->
    <div class="banner">
      ...
      <div class="product-msg">
        <ul>
          ...
          <li v-for="item in goodsList" :key="item.id">
            ...
            <p>${{item.salePrice}}</p>
            <div class="add-mg">
            <a href="javascript:" @click="addCart(item.productId)"><img src="./../assets/cart1.svg" alt="" style="width:25px;height:25px;"></a>
            </div>
          </li>
        </ul>
        <!-- 无限滚动 -->
...
export default {
  ...
  methods: {
    ...
    getGoodList(flag) {
      ...
      axios.get("/goods/doll", { params: param }).then(response => {
    ...
    detail(productId){
     ...
     priceselect(startPrice,endPrice){
      ...
      console.log(endPrice);
       axios.get("/goods/dollselect", { params: param }).then(response => {
        let res = response.data;
        this.goodsList=res.result.list;
         if(this.goodsList==''){
